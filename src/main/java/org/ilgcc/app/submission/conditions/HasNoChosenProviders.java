...
public class HasNoChosenProviders implements Condition {
    ...
    public HasNoChosenProviders(@Value("${il-gcc.enable-multiple-providers}") boolean enableMultipleProviders) {
        this.enableMultipleProviders = enableMultipleProviders;
    }
    @Override
    public Boolean run(Submission submission) {
        return enableMultipleProviders && isNoProviderSubmission(submission);
    }
}
