...
public class SendProviderDeclinesCareFamilyConfirmationEmail extends SendEmail {
    ...
    public SendProviderDeclinesCareFamilyConfirmationEmail(SendEmailJob sendEmailJob, MessageSource messageSource,
            SubmissionRepositoryService submissionRepositoryService) {
        super(sendEmailJob, messageSource, submissionRepositoryService, "providerResponseFamilyConfirmationEmailSent", "parentContactEmail");
    }
