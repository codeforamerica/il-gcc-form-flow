...
public class SendAllProvidersRespondedFamilyConfirmationEmail extends SendEmail {
    ...
    @Autowired
    public SendAllProvidersRespondedFamilyConfirmationEmail(SendEmailJob sendEmailJob,
            MessageSource messageSource,
            SubmissionRepositoryService submissionRepositoryService) {
        super(sendEmailJob, messageSource, submissionRepositoryService, "providersRespondedOrLinkExpiredFamilyConfirmationEmailSent", "parentContactEmail");
    }

    @Override
    protected ILGCCEmailTemplate emailTemplate(Map<String, Object> emailData) {
        return new AllProvidersRespondedFamilyConfirmationEmailTemplate(emailData,
                messageSource,
    ...
    protected Optional<Map<String, Object>> getEmailData(Submission familySubmission, Map<String, Object> subflowData) {
        return Optional.of(familySubmission.getInputData());
    }
