...
import org.ilgcc.app.email.templates.ProviderNotIdentifiedFamilyEmailTemplate;
...
@Component
@Slf4j
public class SendProviderNotIdentifiedFamilyEmail extends SendEmail {

    @Autowired
    public SendProviderNotIdentifiedFamilyEmail(SendEmailJob sendEmailJob,
    ...
    protected ILGCCEmailTemplate emailTemplate(Map<String, Object> emailData) {
        return new ProviderNotIdentifiedFamilyEmailTemplate(emailData, messageSource,
