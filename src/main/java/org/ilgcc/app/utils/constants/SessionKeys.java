package org.ilgcc.app.utils.constants;

public class SessionKeys {
    public final static String SESSION_KEY_FAMILY_SUBMISSION_ID = "familySubmissionId";
    public final static String SESSION_KEY_PROVIDER_SUBMISSION_STATUS = "providerSubmissionStatus";
