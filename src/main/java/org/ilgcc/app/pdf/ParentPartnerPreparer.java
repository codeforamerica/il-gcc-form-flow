...
public class ParentPartnerPreparer implements SubmissionFieldPreparer {
    ...
    public Map<String, SubmissionField> prepareSubmissionFields(Submission submission, PdfMap pdfMap) {
        ...
        if (parentHasPartner.equals("true") && parentHasQualifyingPartner.equals("true")) {
            ...
            String parentPartnerIsActiveDutyMilitary = (String) submission.getInputData()
                    .getOrDefault("parentPartnerIsServing", "");
            ...
            Map<String, SubmissionField> partnerJobsData = flowIteratorPreparer(submission, "partnerJobs",
                    partnerJobsCompanyFields);
            ...
            results.put("activitiesParentPartnerChildcareReason_WORKING",
                    new SingleField("activitiesParentPartnerChildcareReason_WORKING",
                            String.valueOf(reasonsForChildcareNeed.contains("WORKING")), null));
