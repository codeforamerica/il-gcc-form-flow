...
public class ProviderresponseFlowJourneyTest extends AbstractBasePageTest {
    ...
    @Test
    void ProviderresponseFlowJourneyTest() {
        ...
        // application-id
        assertThat(testPage.getTitle()).isEqualTo(getEnMessage("application-id.title"));
        testPage.findElementTextById("providerResponseFamilyConfirmationCode").equals(CONF_CODE);
        testPage.clickContinue();

        // response
        assertThat(testPage.getTitle()).isEqualTo(getEnMessage("response.title"));
        ...
        assertThat(testPage.findElementsByClass("notice").get(0).getText()).isEqualTo(getEnMessage("submit-complete.notice-yes"));
        ...
        // submit-complete
        assertThat(testPage.getTitle()).isEqualTo(getEnMessage("submit-complete.title"));
        assertThat(testPage.findElementsByClass("notice").get(0).getText()).isEqualTo(getEnMessage("submit-complete.notice-no"));
    }

    @Test
    void providerResponseWithShortLinkFlow() {
        testPage.navigateToFlowScreen("gcc/activities-parent-intro");
