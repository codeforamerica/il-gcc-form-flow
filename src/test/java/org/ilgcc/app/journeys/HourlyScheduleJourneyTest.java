...
public class HourlyScheduleJourneyTest extends AbstractBasePageTest {
    ...
    private static Map<String, Object> child = new HashMap<>();
    ...
    class childcareTimeValidation {
        ...
        @BeforeEach
        void setup() {
            child.putAll(Map.of("firstName", "childFirst", "lastName", "childLast", "needFinancialAssistanceForChild", "true",
        ...
        void missingChildCareTimeRaisesError() {
            ...
            saveSubmission(
                    getSessionSubmissionTestBuilder().withValidSubmissionUpToStep5(List.of(child), List.of(new HashMap<>()))
                            .build());
    ...
    void missingParentPartnerJobTimeRaisesError() {
        ...
        saveSubmission(getSessionSubmissionTestBuilder().withValidSubmissionUpToStep2().withParentPartnerDetails().with(
