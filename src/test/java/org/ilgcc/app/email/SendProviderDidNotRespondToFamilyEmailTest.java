...
public class SendProviderDidNotRespondToFamilyEmailTest {
    ...
    void correctlySetsEmailData() {
        ...
        assertThat(emailData.get("familyIntendedProvider")).isEqualTo("Intended Provider");
    }
    ...
    void correctlyUpdatesEmailSendStatus() {
        assertThat(familySubmission.getInputData().containsKey("providerDidNotRespondEmailSent")).isFalse();
        sendEmailClass.send();

        assertThat(familySubmission.getInputData().containsKey("providerDidNotRespondEmailSent")).isTrue();
        assertThat(familySubmission.getInputData().get("providerDidNotRespondEmailSent")).isEqualTo("true");
    }
    ...
    void correctlySkipsEmailSendWhenEmailStatusIsTrue() {
        ...
        familySubmission.getInputData().put("providerDidNotRespondEmailSent", "true");
