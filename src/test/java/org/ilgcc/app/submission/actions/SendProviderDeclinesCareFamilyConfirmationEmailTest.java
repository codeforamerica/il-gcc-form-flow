...
public class SendProviderDeclinesCareFamilyConfirmationEmailTest {
    ...
    private SendProviderDeclinesCareFamilyConfirmationEmail action;
    ...
    void setUp() {
        ...
        action = new SendProviderDeclinesCareFamilyConfirmationEmail(sendEmailJob, messageSource, submissionRepositoryService);
    }
