...
public class ProviderSubmissionFieldPreparerServiceTest_MultipleProvider {
    ...
    void setUp() {
        ...
        provider1.put("uuid", "first-provider-uuid");
        provider1.put("iterationIsComplete", true);
        provider1.put("childCareProgramName", FAM_INTENDED_PROVIDER_NAME);
        provider1.put("familyIntendedProviderEmail", FAM_INTENDED_PROVIDER_EMAIL);
        provider1.put("familyIntendedProviderPhoneNumber", FAM_INTENDED_PROVIDER_PHONE);

        Map<String, Object> provider2 = new HashMap<>();
        provider2.put("uuid", "first-provider-uuid");
        provider2.put("iterationIsComplete", true);
        provider2.put("childCareProgramName", "S");
        provider2.put("familyIntendedProviderEmail", FAM_INTENDED_PROVIDER_EMAIL);
        provider2.put("familyIntendedProviderPhoneNumber", FAM_INTENDED_PROVIDER_PHONE);
