...
//    }
    ...
    public static void main(String[] args) {
        ...
        String docFilePath = "/Users/mperlman@codeforamerica.org/Downloads/sample.doc"; // Path to the .doc file
        String outputDir = "/Users/mperlman@codeforamerica.org/Downloads/sampleoutput/sample-converted.doc";   // Output directory for the PDF
        ...
        try {
            ...
            JodConverter.convert(new File(docFilePath)).to(new File(outputDir)).execute();
